...
namespace E_STM
{
    class PlusTwentyFour:ElementNew
    {
        public PlusTwentyFour(string Name, Point Location, Panel PlaceForElement):base(Name, Location, PlaceForElement)
        {
