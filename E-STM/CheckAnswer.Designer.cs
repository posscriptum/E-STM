namespace E_STM
{
    partial class CheckAnswer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Убедитесь, что проверяющий принял ваш ответ. В противном случае, ответ не будет з" +
    "асчитан.\r\nХотите продолжить?";
            ...
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.CheckAnswer_FormClosed);
            this.Load += new System.EventHandler(this.CheckAnswer_Load);
